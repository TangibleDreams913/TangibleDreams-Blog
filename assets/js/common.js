...
(function (global) {
  ...
  global.BILIBILI_HOME = BILIBILI_HOME;
  global.PIXIV_HOME = PIXIV_HOME;
  ...
  var NAV_ITEMS = [
    ...
    { label: "文章", href: root() + "article/index.html", match: /^\/article\//, more: true },
    { label: "图片", href: root() + "images/index.html", match: /^\/images\//, more: true },
    { label: "音乐", href: root() + "music/index.html", match: /^\/music\//, more: true },
  ...
  var BILIBILI_ICON_SVG =
    '<svg viewBox="0 0 1024 1024" fill="currentColor" aria-hidden="true">' +
    '<path d="M306.005333 117.632L444.330667 256h135.296l138.368-138.325333a42.666667 ' +
    '42.666667 0 1 1 60.373333 60.373333l-78.037333 77.952L789.333333 256A149.333333 ' +
    '149.333333 0 0 1 938.666667 405.333333v341.333334a149.333333 149.333333 0 0 ' +
    '1-149.333334 149.333333h-554.666666A149.333333 149.333333 0 0 1 85.333333 ' +
    '746.666667v-341.333334A149.333333 149.333333 0 0 1 234.666667 256h88.96L245.632 ' +
    '177.962667a42.666667 42.666667 0 0 1 60.373333-60.373334zM789.333333 ' +
    '341.333333h-554.666666a64 64 0 0 0-63.701334 57.856L170.666667 405.333333v341.333334a64 ' +
    '64 0 0 0 57.856 63.701333L234.666667 810.666667h554.666666a64 64 0 0 0 ' +
    '63.701334-57.813334L853.333333 746.666667v-341.333334A64 64 0 0 0 789.333333 ' +
    '341.333333zM341.333333 469.333333a42.666667 42.666667 0 0 1 42.666667 ' +
    '42.666667v85.333333a42.666667 42.666667 0 1 1-85.333333 0v-85.333333a42.666667 ' +
    '42.666667 0 0 1 42.666666-42.666667z m341.333334 0a42.666667 42.666667 0 0 1 ' +
    '42.666666 42.666667v85.333333a42.666667 42.666667 0 1 1-85.333333 ' +
    '0v-85.333333a42.666667 42.666667 0 0 1 42.666667-42.666667z"/></svg>';

  var PIXIV_ICON_SVG =
    '<svg viewBox="0 0 1024 1024" fill="currentColor" aria-hidden="true">' +
    '<path d="M701.515 301.152c-44.44-46.092-100.245-64.919-163.08-65.107-' +
    '29.552-0.089-58.595 4.617-87.095 12.455-28.961 7.965-56.673 18.839-' +
    '81.996 35.306-3.347 2.176-4.69 4.686-4.695 8.694-0.034 29.713-' +
    '0.333 59.424-0.426 89.137-0.085 27.263-0.018 54.527-0.021 81.79-' +
    '0.004 56.836 0.053 113.674-0.097 170.51-0.015 5.326 1.57 8.393 6.639 10.576' +
    ' 17.881 7.7 36.245 13.85 55.161 18.37 30.808 7.36 62.082 10.876 93.715 12.36' +
    ' 33.75 1.583 66.83-1.28 98.832-12.378 61.328-21.265 105.46-61.217 129.447-121.99' +
    ' 15.492-39.25 17.417-80.058 10.877-121.393-7.146-45.173-25.384-85.268-57.26-118.33z' +
    '" />' +
    '<path d="M512 17.482C238.886 17.482 17.482 238.886 17.482 512S238.886 1006.518 512 1006.518' +
    ' 1006.518 785.114 1006.518 512 785.114 17.482 512 17.482z m327.127 530.516c-18.962' +
    ' 47.58-50.687 84.816-92.709 113.517-43.734 29.872-92.452 46.554-144.647 53.74-' +
    '66.355 9.136-131.115 0.236-195.108-17.307-12.485-3.423-24.767-7.483-37.009-11.676-' +
    '4.732-1.62-5.413-1.201-5.42 3.878-0.049 33.583 0.004 67.165-0.069 100.748-0.008 3.782' +
    ' 1.314 5.86 5.093 7.004 7.233 2.187 14.26 5.003 20.384 9.602 3.594 2.699 6.19 5.968' +
    ' 5.824 10.873-0.43 5.752-3.64 8.957-9.432 8.968-19.872 0.039-39.744 0.014-59.617 0.014' +
    '-19.41 0.006-38.82-0.103-58.23 0.082-4.736 0.045-8.025-1.288-9.814-5.842-1.798-4.575' +
    '-0.752-8.45 2.566-11.847 5.698-5.833 13.181-8.404 20.593-11 7.625-2.668 7.8-0.933' +
    ' 7.8-10.86-0.02-151.738-0.02-303.476-0.076-455.215-0.001-2.353 1.227-5.726-1.09-6.829' +
    '-2.297-1.094-4.167 1.976-6 3.442-22.584 18.058-43.474 37.783-60.052 61.694-0.527 0.76' +
    '-1.03 1.537-1.588 2.273-5.878 7.727-9.827 15.6-5.76 25.855 1.946 4.91 1.707 10.59' +
    ' 0.282 15.968-0.937 3.532-2.436 6.64-5.44 8.865-5.016 3.718-8.469 3.16-11.788-2.085' +
    '-12.847-20.308-25.59-40.682-38.532-60.928-2.117-3.313-1.999-5.634 0.715-8.492' +
    ' 17.758-18.692 37.058-35.675 57.256-51.635 51.148-40.413 106.911-72.725 168.335-94.902' +
    ' 40.036-14.455 81.234-23.72 123.709-27.312 49.596-4.194 98.488-0.765 146.365 13.295' +
    ' 50.8 14.919 95.584 40.146 131.966 79.103 36.324 38.896 58.162 84.856 65.163 137.62' +
    ' 5.425 40.866 1.694 80.839-13.67 119.389z" /></svg>';

  var STEAM_ICON_SVG = 
    '<svg viewBox="0 0 1024 1024" fill="currentColor" aria-hidden="true">' +
    '<path d="M511.104 0C242.261333 0 21.802667 207.36 0.938667 470.912l274.432 ' +
    '113.408a144.512 144.512 0 0 1 81.578666-25.173333c2.688 0 5.333333 0.170667 ' +
    '8.021334 0.256l122.069333-176.725334V380.16a193.194667 193.194667 0 0 1 ' +
    '193.024-193.024c106.410667 0 193.024 86.656 193.024 193.152s-86.613333 ' +
    '193.066667-193.024 193.066667h-4.48l-173.909333 124.202666c0 2.218667 0.170667 ' +
    '4.48 0.170666 6.784a144.725333 144.725333 0 0 1-144.64 144.896 145.578667 ' +
    '145.578667 0 0 1-142.122666-116.352L18.602667 651.52C79.445333 866.432 276.736 ' +
    '1024 511.104 1024c282.752 0 511.957333-229.248 511.957333-512S793.813333 0 511.104 ' +
    '0zM321.706667 776.96l-62.848-26.026667c11.178667 23.168 30.464 42.624 56.064 ' +
    '53.333334a108.842667 108.842667 0 0 0 142.378666-141.824 108.672 108.672 0 0 ' +
    '0-138.88-60.288l64.981334 26.88a80.128 80.128 0 0 1-61.653334 147.925333H321.706667z ' +
    'm487.04-396.928a128.810667 128.810667 0 0 0-128.64-128.64 128.64 128.64 0 1 0 128.64 ' +
    '128.64z m-224.981334-0.213333a96.597333 96.597333 0 1 1 193.322667 0 96.725333 96.725333 ' +
    '0 0 1-96.682667 96.64 96.597333 96.597333 0 0 1-96.64-96.64z" /></svg>'
  ...
  function buildNavHTML() {
    ...
    return (
      ...
      '<div class="nav-right">' +
        ...
        '<a class="github-link bilibili-link" href="' + BILIBILI_HOME + '" target="_blank" rel="noopener">' +
          BILIBILI_ICON_SVG + "<span>Bilibili</span></a>" +
        '<a class="github-link pixiv-link" href="' + PIXIV_HOME + '" target="_blank" rel="noopener">' +
          PIXIV_ICON_SVG + "<span>Pixiv</span></a>" +
        '<a class="github-link steam-link" href="' + STEAM_PROFILE + '" target="_blank" rel="noopener">' +
          STEAM_ICON_SVG + "<span>Steam</span></a>" +
